...
def main():
    pygame.init()
    pygame.display.set_caption("PyMario v0.4")
    logo = pygame.image.load("data/logo.png")
    portalgun = pygame.image.load("data/portalgun2.png")
    pygame.display.set_icon(logo)
    screen = pygame.display.set_mode((1220, 400),0,32)
    #Create some groups.
            ...
            if e.type == KEYDOWN:
                ...
                if e.key == K_w:
                    if not player.jumping:
                        ...
                        player.jumping = True
                if e.key == K_1:#MAIN CHARECTER CHANGE PART
                   # player.image = pygame.image.load("data/portalgun.png") #MAIN CHARECTER CHANGE PART
                    pass
        key = pygame.key.get_pressed()#SLO MOTION PART
        if key[pygame.K_m]:#SLO MOTION PART
            clock.tick(10)#SLO MOTION PART
        sprite = portalgun
